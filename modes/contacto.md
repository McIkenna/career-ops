...
2. **Select primary target**: the person who would benefit most from having the candidate on board
...
3. **Generate message** with a 3-sentence framework:
   ...
   - **Sentence 3 (Proposal)**: Quick, no-pressure chat ("Would love to chat about [specific topic] for 15 min")
